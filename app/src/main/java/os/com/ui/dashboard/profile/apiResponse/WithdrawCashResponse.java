...
public class WithdrawCashResponse implements Serializable {
    ...
    /**
     * response : {"status":true,"message":"","data":{"mobile_no":"123456789","email":"nidhi@mailinator.com","email_verify":true,"pen_verify":0,"bank_account_verify":0}}
     */
    ...
    public static class ResponseBean {
         ...
         * status : true
         * message :
         * data : {"mobile_no":"123456789","email":"nidhi@mailinator.com","email_verify":true,"pen_verify":0,"bank_account_verify":0}
         */
